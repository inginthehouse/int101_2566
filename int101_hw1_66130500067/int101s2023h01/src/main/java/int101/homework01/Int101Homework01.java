...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
      ...
      3.4 Show in this "work03UseOfUtilityClass" method how to use 
         ...
         */
        System.out.println("Your BMI : " + MyUtil.calculateBMI(43.0, 1.62));
        System.out.println("Average : " + MyUtil.average(5, 5, 5));
    }
    ...
    static void work04UseOfObjectClass() {
      ...
      4.3 Show in this "work04UseOfObjectClass" method how to use 
        ...
        BankAccount acc1 = new BankAccount(101, person1);
        // acc2
        Person person2 = new Person(2);
        BankAccount acc2 = new BankAccount(102, person2);
        // test deposit
        acc1.deposit(11000);
        acc2.deposit(2000);
